...
public record ChavePixDTO(String codigoInstituicao, String agencia, String conta, String tipoConta, String tipoChave, String valorChave) {
    ...
    public static ChavePixDTO from(ChavePix chavePix){
        return new ChavePixDTO(chavePix.getDadosBancarios().codigoBanco(), chavePix.getDadosBancarios().agencia(), chavePix.getDadosBancarios().conta(), chavePix.getDadosBancarios().tipoDeContaBancaria().name(), chavePix.getTipo().name(), chavePix.getValor());
    }
