...
public class AtivarCommand implements Command {

    private GerenciarChavePix service;
    private Map<String, String> params;

    public AtivarCommand(GerenciarChavePix service, Map<String, String> mapaDeParametros) {
    ...
    public void execute() {
        ...
        try {
            service.ativar(tipoDaChave, valorDaChave);
